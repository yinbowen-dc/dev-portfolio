...
export const DATA = {
  ...
  about:
    "Hey, I'm a Data Engineer based in [Beijing](https://maps.app.goo.gl/UujHe5K394Fvpv3M7), currently grinding at Kuaishou ([Kwai](https://zh.wikipedia.org/wiki/%E5%BF%AB%E6%89%8B_(%E8%BB%9F%E9%AB%94))). I'm focused on providing PB-level data insights and stability assurance for e-commerce & search business. Besides that, I'm keeping up with AI & Web3 tech, always staying in sync with the latest innovations. I'm also a quant trader (though I'm still in the red, but profitability is just around the corner!).When I'm not deep in code, you'll find me buried in books, cruising on my motorcycle, or skateboarding (don't ask me how I have so much time - the perks of being single and staying off TikTok 😎). My idol is Elon Musk - despite his controversial political moves, I really admire his spirit. I'm aspiring to become a tech geek who creates world-changing products (maybe hardware-software services - still exploring, keeping an open mind, and believing in possibilities).",
  ...
  // todo
  contact: {
    email: "self_effacing@163.com",
    tel: "+8613092374334",
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/yinbowen-dc",
        icon: Icons.github,
      ...
      Instagram: {
        name: "Instagram",
        url: "https://www.instagram.com/luogaiyu3/?igsh=MTJyZmloazkyODZtcA%3D%3D#",
        icon: Icons.x,
